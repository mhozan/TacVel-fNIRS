function [scaledoutput]=rescale2(input,varargin)
% [scaledoutput]=rescale2(input) rescales the range of the input  to [0,1] range
% [scaledoutput]=rescale2(input,[a b]) rescales the range of the input  to
